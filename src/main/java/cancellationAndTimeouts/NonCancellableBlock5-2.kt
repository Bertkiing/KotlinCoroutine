...
fun main() = runBlocking{
    ...
    delay(1300L)
    println("cancellationAndTimeouts.cancellationAndTimeouts.ComposingSuspendingFunctions.main:I'm tired for waiting...")
    job.cancelAndJoin()
    println("cancellationAndTimeouts.cancellationAndTimeouts.ComposingSuspendingFunctions.main:Now I can quit safely ... ${Thread.currentThread().name}")
}